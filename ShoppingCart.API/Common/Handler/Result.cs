namespace ShoppingCart.API.Common.Handler
{
    public class Result<T>
    {
        ...
        public static Task<Result<T>> SuccessAsync(T model, string message, bool success, CancellationToken cancellationToken)
        {
            return Task.FromResult<Result<T>>(new Result<T> { Data = model, IsSuccess = success, Message = message,});
        }
